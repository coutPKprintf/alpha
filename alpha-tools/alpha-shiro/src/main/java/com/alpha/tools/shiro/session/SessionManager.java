package com.alpha.tools.shiro.session;
...
/**
 * Created by chenwen on 16/10/17.
 */
public class SessionManager extends DefaultWebSessionManager {
    @Value("#{shiro.active.sessions.cache.name}")
    private String name;
    ...
    protected Serializable getSessionId(ServletRequest request, ServletResponse response) {
        ...
        // ((ShiroHttpServletRequest) request).getQueryString()
//        String queryString = ((ShiroHttpServletRequest) request).getQueryString();
//        String queryJson = HttpUtils.getRequestBody(queryString);

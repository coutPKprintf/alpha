...
public class PageStaticSqlSource extends PageSqlSource {
    ...
    protected BoundSql getCountBoundSql(Object parameterObject) {
        return new BoundSql(configuration, localParser.get().getCountSql(sql,localWhere.get()), parameterMappings, parameterObject);
    }
    ...
    protected BoundSql getPageBoundSql(Object parameterObject) {
        ...
        tempSql = localParser.get().getPageSql(tempSql,localWhere.get());
